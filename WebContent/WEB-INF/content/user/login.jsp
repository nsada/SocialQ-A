	...
	<div class="col-md-4 col-sm-8 vertical-center">
		...
		<form role="form" action="loginPro" method="post">
			...
			<div style="margin: 10px">
				...
				<a
					href="https://graph.qq.com/oauth2.0/authorize?response_type=code&amp;client_id=101366334&amp;redirect_uri=http%3a%2f%2f127.0.0.1%3a9080%2fSocialQ-A%2fAfterLoginAction.action&amp;state=test"
					style="float: left;"> <img width="24" height="24 "
					src="<%=request.getContextPath()%>/images/tencentLogin.jpg"></a>
			</div>

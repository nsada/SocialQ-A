...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/bootstrap.min.css"> </script>
</head>
<!--return validate()和validate()在于是否清空表单-->
<body onload="load_greeting()">
	<div align="left">
		<form id="test" onSubmit="return validate()" action="registPro"
			method="post">
			<table>
				<tr>
					<td>Name*:</td>
					<td><input type="text" class="form-control"
						placeholder="请输入用户名" name="user.name" id="name" size="20"
						onChange='check("name")'></td>
					<td id="nameCheck" class="check" hidden="true">*姓名不能为空</td>
				</tr>
				<tr>
					<td>Age:</td>
					<td><input type="text" name="Age" id="age" size="20"
						onChange='check("age")'></td>
				...
				<tr>
					...
					<td><input type="password" name="user.password" id="password"
						size="20" onChange='check("password")'></td>
					<td id="passwordCheck" class="check" hidden="true">*password
						length less than 8</td>
				</tr>
				<tr>
					<td>Confirm Password*:</td>
					<td><input type="password" name="cpassword" id="cpassword"
						size="20" onChange='check("cpassword")'></td>
					<td id="cpasswordCheck" class="check" hidden="true">*Two
						passwd is not same</td>
				</tr>
				<tr>
					<td>Email*:</td>
					<td><input type="email" name="email" id="email" size="20"
						onChange='check(this.id)'></td>
